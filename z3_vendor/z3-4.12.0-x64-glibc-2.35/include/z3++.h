...
Copyright (c) 2012 Microsoft Corporation
    ...
    However, if you use the C API directly, you will have to check the error
conditions manually. Of course, you can invoke the method check_error() of the
...
/**
   \brief A Context manages all other Z3 objects, global configuration options,
   etc.
*/
...
private:
  ...
  void init(config &c) { set_context(Z3_mk_context_rc(c)); }
...
public:
  ...
  */
  ...
  void check_parser_error() const { check_error(); }

  /**
     \brief The C++ API uses by defaults exceptions on errors.
     For applications that don't work well with exceptions (there should be only
     few) you have the ability to turn off exceptions. The tradeoffs are that
     applications have to be very careful about using check_error() after calls
     that may result in an erroneous state.
   */
  ...
  */
  ...
  /**
     \brief Interrupt the current procedure being executed by any object managed
     by this context. This is a soft interruption: there is no guarantee the
     object will actually stop.
  */
  ...
  */
  sort real_sort();
  /**
     \brief Return the Bit-vector sort of size \c sz. That is, the sort for
     bit-vectors of size \c sz.
  */
  ...
  /**
     ...
     Example: Given a context \c c, <tt>c.array_sort(c.int_sort(),
     c.bool_sort())</tt> is an array sort from integer to Boolean.
  */
  ...
  /**
     \brief Return a FloatingPoint sort with given precision bitwidth (16, 32,
     64 or 128).
   */
  ...
  /**
     ...
     \c cs and \c ts are output parameters. The method stores in \c cs the
     constants corresponding to the enumerated elements, and in \c ts the
     predicates for testing if terms of the enumeration sort correspond to an
     enumeration.
  */
  sort enumeration_sort(char const *name, unsigned n,
                        char const *const *enum_names, func_decl_vector &cs,
                        func_decl_vector &ts);

  /**
     \brief Return a tuple constructor.
     \c name is the name of the returned constructor,
     \c n are the number of arguments, \c names and \c sorts are their projected
     sorts. \c projs is an output parameter. It contains the set of projection
     functions.
  */
  func_decl tuple_sort(char const *name, unsigned n, char const *const *names,
  ...
  */
  ...
  /**
     \brief create an uninterpreted sort with the name given by the string or
     symbol.
   */
  sort uninterpreted_sort(char const *name);
  sort uninterpreted_sort(symbol const &name);

  func_decl function(symbol const &name, unsigned arity, sort const *domain,
                     sort const &range);
  func_decl function(char const *name, unsigned arity, sort const *domain,
                     sort const &range);
  func_decl function(symbol const &name, sort_vector const &domain,
                     sort const &range);
  func_decl function(char const *name, sort_vector const &domain,
                     sort const &range);
  func_decl function(char const *name, sort const &domain, sort const &range);
  func_decl function(char const *name, sort const &d1, sort const &d2,
                     sort const &range);
  func_decl function(char const *name, sort const &d1, sort const &d2,
                     sort const &d3, sort const &range);
  func_decl function(char const *name, sort const &d1, sort const &d2,
                     sort const &d3, sort const &d4, sort const &range);
  func_decl function(char const *name, sort const &d1, sort const &d2,
                     sort const &d3, sort const &d4, sort const &d5,
                     sort const &range);

  func_decl recfun(symbol const &name, unsigned arity, sort const *domain,
                   sort const &range);
  func_decl recfun(char const *name, unsigned arity, sort const *domain,
                   sort const &range);
  func_decl recfun(char const *name, sort const &domain, sort const &range);
  func_decl recfun(char const *name, sort const &d1, sort const &d2,
                   sort const &range);
  ...
  expr_vector parse_string(char const *s, sort_vector const &sorts,
                           func_decl_vector const &decls);
  expr_vector parse_file(char const *s, sort_vector const &sorts,
                         func_decl_vector const &decls);
};
...
public:
  ...
  void set(char const *k, char const *s) {
    Z3_params_set_symbol(ctx(), m_params, ctx().str_symbol(k),
                         ctx().str_symbol(s));
  }
...
/**
   \brief A Z3 sort (aka type). Every expression (i.e., formula or term) in Z3
   has a sort.
*/
...
/**
   \brief Function declaration (aka function definition). It is the signature of
   interpreted and uninterpreted functions in Z3. The basic building block in Z3
   is the function application.
*/
...
public:
  ...
  expr operator()(expr const &a1, expr const &a2, expr const &a3,
                  expr const &a4) const;
  expr operator()(expr const &a1, expr const &a2, expr const &a3,
                  expr const &a4, expr const &a5) const;
...
/**
   \brief A Z3 expression is used to represent formulas and terms. For Z3, a
   formula is any expression of sort Boolean. Every expression has a sort.
*/
...
public:
  ...
  */
  ...
  /**
     \brief Return true if this expression is a constant (i.e., an application
     with 0 arguments).
  */
  ...
  */
  ...
  /**
     \brief Return Boolean expression to test for whether an FP expression is
     inf
  */
  ...
  /**
     \brief Return Boolean expression to test for whether an FP expression is a
     NaN
  */
  ...
  */
  ...
  /**
   * Retrieve lower and upper bounds for algebraic numerals based on a decimal
   * precision
   */
  ...
  */
  ...
  Z3_lbool bool_value() const { return Z3_get_bool_value(ctx(), m_ast); }
  ...
  /**
     ...
     The string can be accessed using \c get_string() and \c
     get_escaped_string()
   */
  ...
  */
  ...
  /**
     \brief Return an expression representing <tt>a and b</tt>.
     The C++ Boolean value \c b is automatically converted into a Z3 Boolean
     constant.
  ...
  */
  ...
  /**
     \brief Return an expression representing <tt>a and b</tt>.
     The C++ Boolean value \c a is automatically converted into a Z3 Boolean
     constant.
  ...
  */
  ...
  /**
     \brief Create an expression of FloatingPoint sort from three bit-vector
     expressions
  */
  ...
  */
  ...
  /**
     \brief Return a simplified version of this expression. The parameter \c p
  ...
  */
  ...
  public:
    ...
    bool operator==(iterator const &other) noexcept { return i == other.i; }
    bool operator!=(iterator const &other) noexcept { return i != other.i; }
...
inline expr operator^(expr const &a, expr const &b) {
  check_context(a, b);
  Z3_ast r =
      a.is_bool() ? Z3_mk_xor(a.ctx(), a, b) : Z3_mk_bvxor(a.ctx(), a, b);
  a.check_error();
  return expr(a.ctx(), r);
}
inline expr operator^(expr const &a, int b) {
...
inline expr ubv_to_fpa(expr const &t, sort s) {
  assert(t.is_bv());
  Z3_ast r =
      Z3_mk_fpa_to_fp_unsigned(t.ctx(), t.ctx().fpa_rounding_mode(), t, s);
  t.check_error();
  return expr(t.ctx(), r);
}
...
inline expr round_fpa_to_closest_integer(expr const &t) {
  assert(t.is_fpa());
  Z3_ast r =
      Z3_mk_fpa_round_to_integral(t.ctx(), t.ctx().fpa_rounding_mode(), t);
  t.check_error();
  return expr(t.ctx(), r);
}
...
/**
   ...
   This function allows the user to use the whole C API with the C++ layer
...
array<T>::array(ast_vector_tpl<T2> const &v)
    : m_array(new T[v.size()]), m_size(v.size()) {
...
// The C API should be used for creating quantifiers with patterns, weights,
// many variables, etc.
...
inline expr forall(expr const &x1, expr const &x2, expr const &x3,
                   expr const &b) {
  check_context(x1, b);
  check_context(x2, b);
  check_context(x3, b);
...
inline expr exists(expr const &x1, expr const &x2, expr const &x3,
                   expr const &b) {
  check_context(x1, b);
  check_context(x2, b);
  check_context(x3, b);
...
inline expr lambda(expr const &x1, expr const &x2, expr const &x3,
                   expr const &b) {
  check_context(x1, b);
  check_context(x2, b);
  check_context(x3, b);
...
public:
  ...
  func_decl operator[](int i) const {
    assert(0 <= i);
    return static_cast<unsigned>(i) < num_consts()
               ? get_const_decl(i)
               : get_func_decl(i - num_consts());
  }
...
public:
  ...
  void add(expr const &e, char const *p) { add(e, ctx().bool_const(p)); }
  ...
  check_result check(unsigned n, expr *const assumptions) {
    ...
    Z3_lbool r =
        Z3_solver_check_assumptions(ctx(), m_solver, n, _assumptions.ptr());
    check_error();
    return to_check_result(r);
  }
  ...
  check_result consequences(expr_vector &assumptions, expr_vector &vars,
                            expr_vector &conseq) {
    Z3_lbool r =
        Z3_solver_get_consequences(ctx(), m_solver, assumptions, vars, conseq);
    check_error();
    return to_check_result(r);
  }
  ...
  std::string to_smt2(char const *status = "unknown") {
    ...
    return std::string(Z3_benchmark_to_smtlib_string(ctx(), "", "", status, "",
                                                     sz, fmls, fml));
  }
  ...
  public:
    cube_iterator(solver &s, expr_vector &vars, unsigned &cutoff, bool end)
        : m_solver(s), m_cutoff(cutoff), m_vars(vars), m_cube(s.ctx()),
          m_end(end), m_empty(false) {
      if (!m_end) {
        inc();
      }
    }
  ...
  public:
    cube_generator(solver &s)
        : m_solver(s), m_cutoff(0xFFFFFFFF), m_default_vars(s.ctx()),
...
public:
  goal(context &c, bool models = true, bool unsat_cores = false,
       bool proofs = false)
      : object(c) {
...
public:
  ...
  apply_result operator()(goal const &g) const { return apply(g); }
...
inline tactic par_or(unsigned n, tactic const *tactics) {
  if (n == 0) {
    Z3_THROW(
        exception("a non-zero number of tactics need to be passed to par_or"));
  }
  array<Z3_tactic> buffer(n);
  for (unsigned i = 0; i < n; ++i)
    buffer[i] = tactics[i];
  return tactic(tactics[0u].ctx(),
...
public:
  ...
  handle add(expr const &e, unsigned weight) { return add_soft(e, weight); }
  ...
  void push() { Z3_optimize_push(ctx(), m_opt); }
  void pop() { Z3_optimize_pop(ctx(), m_opt); }
  check_result check() {
...
public:
  ...
  check_result query(func_decl_vector &relations) {
    ...
    Z3_lbool r =
        Z3_fixedpoint_query_relations(ctx(), m_fp, rs.size(), rs.ptr());
    check_error();
    return to_check_result(r);
  }
  expr get_answer() {
...
template <> inline sort context::fpa_sort<16>() { return fpa_sort(5, 11); }

template <> inline sort context::fpa_sort<32>() { return fpa_sort(8, 24); }

template <> inline sort context::fpa_sort<64>() { return fpa_sort(11, 53); }

template <> inline sort context::fpa_sort<128>() { return fpa_sort(15, 113); }
...
inline sort context::enumeration_sort(char const *name, unsigned n,
  ...
  sort s =
      to_sort(*this, Z3_mk_enumeration_sort(*this, _name, n, _enum_names.ptr(),
                                            _cs.ptr(), _ts.ptr()));
  check_error();
  for (unsigned i = 0; i < n; i++) {
...
inline func_decl context::tuple_sort(char const *name, unsigned n,
  ...
  Z3_func_decl tuple;
  sort _ignore_s =
      to_sort(*this, Z3_mk_tuple_sort(*this, _name, n, _names.ptr(),
...
public:
  ...
  void add(symbol const &name, symbol const &rec, unsigned n,
           symbol const *names, sort const *fields) {
    array<unsigned> sort_refs(n);
    array<Z3_sort> sorts(n);
    array<Z3_symbol> _names(n);
    for (unsigned i = 0; i < n; ++i)
      sorts[i] = fields[i], _names[i] = names[i];
    cons.push_back(Z3_mk_constructor(ctx, name, rec, n, _names.ptr(),
                                     sorts.ptr(), sort_refs.ptr()));
  ...
  void query(unsigned i, func_decl &constructor, func_decl &test,
             func_decl_vector &accs) {
    Z3_func_decl _constructor;
    Z3_func_decl _test;
    array<Z3_func_decl> accessors(num_fields[i]);
    accs.resize(0);
    Z3_query_constructor(ctx, cons[i], num_fields[i], &_constructor, &_test,
                         accessors.ptr());
...
inline constructor_list::constructor_list(constructors const &cs)
    : ctx(cs.ctx) {
...
inline sort_vector context::datatypes(unsigned n, symbol const *names,
                                      constructor_list *const *cons) {
...
inline func_decl context::function(symbol const &name, unsigned arity,
...
inline func_decl context::function(char const *name, unsigned arity,
                                   sort const *domain, sort const &range) {
  return function(range.ctx().str_symbol(name), arity, domain, range);
}

inline func_decl context::function(symbol const &name,
                                   sort_vector const &domain,
                                   sort const &range) {
...
inline func_decl context::function(char const *name, sort_vector const &domain,
                                   sort const &range) {
  return function(range.ctx().str_symbol(name), domain, range);
}

inline func_decl context::function(char const *name, sort const &domain,
                                   sort const &range) {
...
inline func_decl context::function(char const *name, sort const &d1,
                                   sort const &d2, sort const &range) {
...
inline func_decl context::function(char const *name, sort const &d1,
                                   sort const &d2, sort const &d3,
                                   sort const &d4, sort const &range) {
  check_context(d1, range);
  check_context(d2, range);
  check_context(d3, range);
...
inline func_decl context::recfun(symbol const &name, unsigned arity,
                                 sort const *domain, sort const &range) {
  array<Z3_sort> args(arity);
  for (unsigned i = 0; i < arity; i++) {
    check_context(domain[i], range);
...
inline func_decl context::recfun(char const *name, unsigned arity,
                                 sort const *domain, sort const &range) {
  return recfun(str_symbol(name), arity, domain, range);
}

inline func_decl context::recfun(char const *name, sort const &d1,
                                 sort const &range) {
...
inline void context::recdef(func_decl f, expr_vector const &args,
                            expr const &body) {
...
inline func_decl context::user_propagate_function(symbol const &name,
                                                  sort_vector const &domain,
                                                  sort const &range) {
  check_context(domain, range);
  array<Z3_sort> domain1(domain);
  Z3_func_decl f = Z3_solver_propagate_declare(
      range.ctx(), name, domain1.size(), domain1.ptr(), range);
  check_error();
  return func_decl(*this, f);
}
...
inline expr context::fpa_const(char const *name, unsigned ebits,
                               unsigned sbits) {
...
inline expr context::string_val(std::u32string const &s) {
  Z3_ast r =
      Z3_mk_u32string(m_ctx, (unsigned)s.size(), (unsigned const *)s.c_str());
  check_error();
  return expr(*this, r);
}
...
inline expr func_decl::operator()(expr const &a1, expr const &a2,
                                  expr const &a3) const {
  check_context(*this, a1);
  check_context(*this, a2);
...
inline expr func_decl::operator()(expr const &a1, expr const &a2,
                                  expr const &a3, expr const &a4) const {
  check_context(*this, a1);
  check_context(*this, a2);
  check_context(*this, a3);
...
inline func_decl function(symbol const &name, unsigned arity,
                          sort const *domain, sort const &range) {
  return range.ctx().function(name, arity, domain, range);
}
inline func_decl function(char const *name, unsigned arity, sort const *domain,
                          sort const &range) {
  return range.ctx().function(name, arity, domain, range);
}
inline func_decl function(char const *name, sort const &domain,
                          sort const &range) {
  return range.ctx().function(name, domain, range);
}
inline func_decl function(char const *name, sort const &d1, sort const &d2,
                          sort const &range) {
...
inline func_decl function(char const *name, sort_vector const &domain,
                          sort const &range) {
  return range.ctx().function(name, domain, range);
}
inline func_decl function(std::string const &name, sort_vector const &domain,
                          sort const &range) {
  return range.ctx().function(name.c_str(), domain, range);
}

inline func_decl recfun(symbol const &name, unsigned arity, sort const *domain,
                        sort const &range) {
  return range.ctx().recfun(name, arity, domain, range);
}
inline func_decl recfun(char const *name, unsigned arity, sort const *domain,
                        sort const &range) {
  return range.ctx().recfun(name, arity, domain, range);
}
...
inline func_decl recfun(char const *name, sort const &d1, sort const &d2,
                        sort const &range) {
...
inline expr empty_set(sort const &s) { MK_EXPR1(Z3_mk_empty_set, s); }

inline expr full_set(sort const &s) { MK_EXPR1(Z3_mk_full_set, s); }
...
inline expr set_complement(expr const &a) { MK_EXPR1(Z3_mk_set_complement, a); }
...
inline expr to_re(expr const &s) { MK_EXPR1(Z3_mk_seq_to_re, s); }
inline expr in_re(expr const &s, expr const &re) {
  MK_EXPR2(Z3_mk_seq_in_re, s, re);
}
inline expr plus(expr const &re) { MK_EXPR1(Z3_mk_re_plus, re); }
inline expr option(expr const &re) { MK_EXPR1(Z3_mk_re_option, re); }
inline expr star(expr const &re) { MK_EXPR1(Z3_mk_re_star, re); }
...
inline expr re_complement(expr const &a) { MK_EXPR1(Z3_mk_re_complement, a); }
...
inline expr_vector context::parse_string(char const *s,
  ...
  Z3_ast_vector r = Z3_parse_smtlib2_string(
      *this, s, sorts.size(), sort_names.ptr(), sorts1.ptr(), decls.size(),
      decl_names.ptr(), decls1.ptr());
  check_error();
  return expr_vector(*this, r);
}

inline expr_vector context::parse_file(char const *s, sort_vector const &sorts,
                                       func_decl_vector const &decls) {
  array<Z3_symbol> sort_names(sorts.size());
  array<Z3_symbol> decl_names(decls.size());
  array<Z3_sort> sorts1(sorts);
  ...
  Z3_ast_vector r = Z3_parse_smtlib2_file(
      *this, s, sorts.size(), sort_names.ptr(), sorts1.ptr(), decls.size(),
      decl_names.ptr(), decls1.ptr());
  check_error();
  return expr_vector(*this, r);
...
inline func_decl_vector sort::constructors() {
  ...
  for (unsigned i = 0; i < n; ++i)
    cs.push_back(
        func_decl(ctx(), Z3_get_datatype_sort_constructor(ctx(), *this, i)));
  return cs;
}
...
inline func_decl_vector sort::recognizers() {
  ...
  for (unsigned i = 0; i < n; ++i)
    rs.push_back(
        func_decl(ctx(), Z3_get_datatype_sort_recognizer(ctx(), *this, i)));
  return rs;
}
...
inline func_decl_vector func_decl::accessors() {
  ...
  for (unsigned i = 0; i < n; ++i)
    as.push_back(func_decl(
        ctx(), Z3_get_datatype_sort_constructor_accessor(ctx(), s, idx, i)));
  return as;
}
...
inline expr expr::substitute(func_decl_vector const &funs,
  ...
  Z3_ast r =
      Z3_substitute_funs(ctx(), m_ast, dst.size(), _funs.ptr(), _dst.ptr());
  check_error();
  return expr(ctx(), r);
}

typedef std::function<void(expr const &proof, expr_vector const &clause)>
    on_clause_eh_t;
...
class on_clause {
  ...
  static void _on_clause_eh(void *_ctx, Z3_ast _proof,
...
class user_propagator_base {
  ...
  struct scoped_cb {
    ...
    scoped_cb(void *_p, Z3_solver_callback cb)
        : p(*static_cast<user_propagator_base *>(_p)) {
      p.cb = cb;
    }
    ~scoped_cb() { p.cb = nullptr; }
  };
  ...
  static void fixed_eh(void *_p, Z3_solver_callback cb, Z3_ast _var,
                       Z3_ast _value) {
    user_propagator_base *p = static_cast<user_propagator_base *>(_p);
    scoped_cb _cb(p, cb);
  ...
  static void decide_eh(void *_p, Z3_solver_callback cb, Z3_ast *_val,
                        unsigned *bit, Z3_lbool *is_pos) {
    user_propagator_base *p = static_cast<user_propagator_base *>(_p);
    scoped_cb _cb(p, cb);
    expr val(p->ctx(), *_val);
...
public:
  ...
  virtual ~user_propagator_base() {
    for (auto &subcontext : subcontexts) {
      subcontext
          ->detach(); // detach first; the subcontexts will be freed internally!
      delete subcontext;
    }
  }

  context &ctx() { return c ? *c : s->ctx(); }
  ...
  */
  ...
  virtual void decide(expr & /*val*/, unsigned & /*bit*/,
                      Z3_lbool & /*is_pos*/) {}
  ...
  /**
     ...
     If the \c fixed() callback is registered and if \c e is a Boolean or
     Bit-vector, the \c fixed() callback gets invoked when \c e is bound to a
     value. If the \c eq() callback is registered, then equalities between
     registered expressions are reported. A consumer can use the \c propagate or
     \c conflict functions to invoke propagations or conflicts as a consequence
     of these callbacks. These functions take a list of identifiers for
     registered expressions that have been fixed. The list of identifiers must
     correspond to already fixed values. Similarly, a list of propagated
     equalities can be supplied. These must correspond to equalities that have
     been registered during a callback.
   */
  ...
  void conflict(expr_vector const &fixed) {
    ...
    Z3_solver_propagate_consequence(ctx(), cb, fixed.size(), _fixed.ptr(), 0,
                                    nullptr, nullptr, conseq);
  }

  void conflict(expr_vector const &fixed, expr_vector const &lhs,
    ...
    Z3_solver_propagate_consequence(ctx(), cb, fixed.size(), _fixed.ptr(),
                                    lhs.size(), _lhs.ptr(), _rhs.ptr(), conseq);
  }
  ...
  void propagate(expr_vector const &fixed, expr const &conseq) {
    ...
    array<Z3_ast> _fixed(fixed);
    Z3_solver_propagate_consequence(ctx(), cb, _fixed.size(), _fixed.ptr(), 0,
                                    nullptr, nullptr, conseq);
  }

  void propagate(expr_vector const &fixed, expr_vector const &lhs,
                 expr_vector const &rhs, expr const &conseq) {
    assert(cb);
    assert((Z3_context)conseq.ctx() == (Z3_context)ctx());
    assert(lhs.size() == rhs.size());
    array<Z3_ast> _fixed(fixed);
    ...
    Z3_solver_propagate_consequence(ctx(), cb, _fixed.size(), _fixed.ptr(),
                                    lhs.size(), _lhs.ptr(), _rhs.ptr(), conseq);
  }
};
