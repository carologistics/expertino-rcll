 ...
 *
 *  Automatically Generated: 2024-01-06 13:26:03
 ****************************************************************************/
...
#include "ros_comm_interfaces/NavGraphUpdateStationByTag.hpp"
...
void NavGraphUpdateStationByTag::create_request(
  ...
  request_clients_[env_name][service_name] = this->create_client<
      expertino_msgs::srv::NavGraphInterfaceUpdateStationByTag>(service_name);
  requests_[env_name][service_name] = std::make_shared<
      expertino_msgs::srv::NavGraphInterfaceUpdateStationByTag::Request>();
}
...
void NavGraphUpdateStationByTag::set_array_request(
  ...
  if (field_name == "tag_translation") {
    ...
    requests_[env_name][service_name]->tag_translation =
        values_vector_tag_translation;
  }
  if (field_name == "tag_rotation") {
    ...
    requests_[env_name][service_name]->tag_rotation =
        values_vector_tag_rotation;
  }
...
void NavGraphUpdateStationByTag::request_from_node(
  ...
  auto response_callback =
      [=](rclcpp::Client<
          expertino_msgs::srv::NavGraphInterfaceUpdateStationByTag>::
...
void NavGraphUpdateStationByTag::service_callback(
    rclcpp::Client<expertino_msgs::srv::NavGraphInterfaceUpdateStationByTag>::
        SharedFuture response,
  ...
  while (old_fact) {
    if (old_fact->get_template()->name() ==
            "ros-nav_graph_update_station_by_tag-response" &&
  ...
  CLIPS::Template::pointer fact_template = envs_[env_name]->get_template(
      "ros-nav_graph_update_station_by_tag-message");
