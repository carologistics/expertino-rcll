 ...
 *
 *  Automatically Generated: 2024-01-06 13:23:08
 ****************************************************************************/
...
#include "ros_comm_interfaces/NavGraphGenerateWaitzones.hpp"
...
void NavGraphGenerateWaitzones::create_request(
  ...
  request_clients_[env_name][service_name] = this->create_client<
      expertino_msgs::srv::NavGraphInterfaceGenerateWaitzones>(service_name);
  requests_[env_name][service_name] = std::make_shared<
      expertino_msgs::srv::NavGraphInterfaceGenerateWaitzones::Request>();
}
...
void NavGraphGenerateWaitzones::request_from_node(
  ...
  auto response_callback =
      [=](rclcpp::Client<
          expertino_msgs::srv::NavGraphInterfaceGenerateWaitzones>::SharedFuture
              response) { service_callback(response, service_name, env_name); };
...
void NavGraphGenerateWaitzones::service_callback(
    rclcpp::Client<expertino_msgs::srv::NavGraphInterfaceGenerateWaitzones>::
  ...
  while (old_fact) {
    if (old_fact->get_template()->name() ==
            "ros-nav_graph_generate_waitzones-response" &&
  ...
  CLIPS::Template::pointer fact_template =
      envs_[env_name]->get_template("ros-nav_graph_generate_waitzones-message");
