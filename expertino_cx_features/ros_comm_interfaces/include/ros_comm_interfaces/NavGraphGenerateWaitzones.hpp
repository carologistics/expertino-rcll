...
#include "expertino_msgs/srv/nav_graph_interface_generate_waitzones.hpp"
...
private:
  ...
  std::map<std::string,
           std::map<std::string,
                    rclcpp::Client<
                        expertino_msgs::srv::
                            NavGraphInterfaceGenerateWaitzones>::SharedPtr>>
      request_clients_;
  std::map<std::string,
           std::map<std::string,
                    std::shared_ptr<
                        expertino_msgs::srv::
                            NavGraphInterfaceGenerateWaitzones::Request>>>
      requests_;
