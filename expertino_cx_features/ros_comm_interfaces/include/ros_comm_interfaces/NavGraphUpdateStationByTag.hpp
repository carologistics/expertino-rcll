/***************************************************************************
 *  NavGraphUpdateStationByTag.hpp
 *
...
#ifndef CX_FEATURES__NAVGRAPHUPDATESTATIONBYTAG_HPP_
#define CX_FEATURES__NAVGRAPHUPDATESTATIONBYTAG_HPP_
...
#include "expertino_msgs/srv/nav_graph_interface_update_station_by_tag.hpp"
#include "rclcpp/rclcpp.hpp"

namespace cx {

class NavGraphUpdateStationByTag : public ClipsFeature, public rclcpp::Node {
public:
...
private:
  ...
  std::map<std::string,
           std::map<std::string,
                    rclcpp::Client<
                        expertino_msgs::srv::
                            NavGraphInterfaceUpdateStationByTag>::SharedPtr>>
      request_clients_;
  std::map<std::string,
           std::map<std::string,
                    std::shared_ptr<
                        expertino_msgs::srv::
                            NavGraphInterfaceUpdateStationByTag::Request>>>
      requests_;
...
#endif // !CX_FEATURES__NAVGRAPHUPDATESTATIONBYTAG_HPP_