...
#include "expertino_msgs/srv/nav_graph_interface_compute.hpp"
...
private:
  ...
  std::map<
      ...
      std::map<std::string,
               rclcpp::Client<
                   expertino_msgs::srv::NavGraphInterfaceCompute>::SharedPtr>>
      request_clients_;
  std::map<
      std::string,
      std::map<std::string,
  ...
  void service_callback(
      rclcpp::Client<
          expertino_msgs::srv::NavGraphInterfaceCompute>::SharedFuture response,
