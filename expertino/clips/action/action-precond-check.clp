(defrule agenda-action-sat
  (pddl-action-condition (plan ?plan-id) (id ?action-id) (state PRECONDITION-SAT) (context ?context))
...
(defrule agenda-action-unsat
  (pddl-action-condition (plan ?plan-id) (id ?action-id) (state PRECONDITION-UNSAT) (context ?context) (unsatisfied-preconditions $?unsats))
  (pddl-action (id ?action-id) (name ?action-name) (params $?action-params))
  =>
