...
(defrule add-order-to-problem
  ...
  ?o-f <- (order (id ?order-id) (name ?name) (workpiece nil) (complexity C0) (base-color ?base-col) (ring-colors $?ring-cols) (cap-color ?cap-col)  (quantity-requested ?qty-requested)
