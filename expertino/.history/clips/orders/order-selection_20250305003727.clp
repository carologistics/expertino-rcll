...
(defrule add-order-to-problem
  ...
  (assert (pddl-planner-call (context test-plan) (goal (expertino-msgs-plan-temporal-goal-create))))
  
  (printout t "=== Finished executing add-order-to-problem and triggered the planner ===" crlf)
