...
(deftemplate request-planner-update)
...
(defrule trigger-planner-update
  ...
  (assert (pddl-planner-call (context test-plan)))  ; Call the planner again
  (retract (request-planner-update))  ; Remove the trigger fact
)
